...
- Result: **forward AUC stable across all 4 walk-forward folds** (mean 0.52, std 0.019); the ensemble beats the market baseline in every fold (mean 1.33×, std 0.045).
...
| 2025-07 ~ 2026-01 | 0.5170 | 265 | 0.3845 | 1.34배 |
| 2026-01 ~ 2026-07 | 0.6027 | 292 | 0.4340 | 1.39배 |
| **평균** | **0.5624** | — | — | **1.33배 (편차 0.045)** |

- 4개 폴드 전부 베이스라인 초과(1.27~1.39배), 편차 0.045로 시장 국면 변화에 안정적.
...
> **설계 의도와의 차이:** 당초 LSTM에 추세 탐지를 맡기려 했으나,
> 데이터는 "이 시장에서 모멘텀 기반 신호는 레짐 의존성이 크다"는 것을 일관되게 보였다.
> 이는 실패가 아니라 **딥러닝 시계열 신호의 레짐 의존성에 대한 실증적 발견**이다.
